...
def prefetch_test(opt):
  ...
  Logger(opt)
  Detector = detector_factory[opt.task if 'meta' not in opt.task else opt.task.split('_')[0]]
  ...
  dataset.run_eval(results, opt.save_dir,test_directly)
